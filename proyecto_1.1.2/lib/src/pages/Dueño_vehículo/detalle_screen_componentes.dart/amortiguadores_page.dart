...
class AmortiguadoresPage extends StatefulWidget {
  @override
  _AmortiguadoresPageState createState() => _AmortiguadoresPageState();
}

class _AmortiguadoresPageState extends State<AmortiguadoresPage> {
  @override
  ...
  Widget _textoAmortiguador1(){
    ...
    return Container(
      ...
      child: Container(
        child: Stack(
          children: [
            Text('Amortiguador delantero: Se encuentra en un 50%',
              style: TextStyle(
              fontFamily: 'Times new roman',
              color: Colors.white,
              fontSize: 15.0,
  ...
  Widget _textoAmortiguador2(){
    ...
    return Container(
      ...
      child: Container(
        child: Stack(
          children: [
            Text('Amortiguador trasero: Se encuentra en un 90%.',
            style: TextStyle(
              fontFamily: 'Times new roman',
              color: Colors.white,
              fontSize: 15.0,
  ...
  Widget _textoAmortiguador3(){
    ...
    return Container(
      padding: const EdgeInsets.only(top: 670.0, right: 50.0, left: 70.0),
      alignment: Alignment.topCenter,
      child: Container(
        child: Stack(
          children: [
            Text('Se recomienda sustituirlos cada 60.000 km',
              style: TextStyle(
                fontFamily: 'Times new roman',
