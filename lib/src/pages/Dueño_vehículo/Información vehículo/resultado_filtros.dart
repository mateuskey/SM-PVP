...
class _ResultadoFiltrosState extends State<ResultadoFiltros> {
  ...
  void initState() {
    ...
    Firebase.initializeApp().whenComplete(() { 
      print("Resultados de filtros cargado");
      setState(() {});
    });
  }
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 140.0,bottom: 155.0, right: 600.0),
      child: Stack(
        children: <Widget>[
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 120.0,bottom: 175.0, right: 600.0),
      child: Stack(
        children: <Widget>[
