...
class ResultadoLiquidos extends StatefulWidget {
  @override
  _ResultadoLiquidosState createState() => _ResultadoLiquidosState();
}

class _ResultadoLiquidosState extends State<ResultadoLiquidos> {

  void initState() {
    super.initState();
    Firebase.initializeApp().whenComplete(() { 
      print("Resultados de líquidos cargado");
      setState(() {});
    });
  }
  ...
  Widget _texto(){
    ...
    return Container(
      ...
      child: Text('Resultados anteriores de líquidos',
        style: TextStyle(
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 190.0,bottom: 190.0, right: 600.0),
      child: Stack(
        children: <Widget>[
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 180.0,bottom: 265.0, right: 600.0),
      child: Stack(
        children: <Widget>[
