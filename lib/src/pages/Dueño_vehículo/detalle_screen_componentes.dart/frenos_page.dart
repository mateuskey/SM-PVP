...
class FrenosPage extends StatefulWidget {
  @override
  _FrenosPageState createState() => _FrenosPageState();
}

class _FrenosPageState extends State<FrenosPage> {
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 100.0,bottom: 200.0, right: 600.0),
      child: Stack(
        children: <Widget>[
