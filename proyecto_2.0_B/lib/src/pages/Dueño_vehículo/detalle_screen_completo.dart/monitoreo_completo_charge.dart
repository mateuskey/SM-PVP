...
class _CompletoCargadaPageState extends State<CompletoCargadaPage> {
  ...
  // 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 140.0, top: 100.0,bottom: 225.0, right:220.0),
      child: Stack(
        children: <Widget>[
  ...
  // 'Porcentaje 5' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 140.0, top: 145.0,bottom: 175.0, right: 220.0),
      child: Stack(
        children: <Widget>[
