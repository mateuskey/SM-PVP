...
class ResultadoNeumaticos extends StatefulWidget {
  @override
  _ResultadoNeumaticosState createState() => _ResultadoNeumaticosState();
}

class _ResultadoNeumaticosState extends State<ResultadoNeumaticos> {
  ...
  Widget _texto(){
    ...
    return Container(
      ...
      child: Text('Resultados anteriores de neumáticos',
        style: TextStyle(
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 170.0,bottom: 190.0, right: 600.0),
      child: Stack(
        children: <Widget>[
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 150.0,bottom: 300.0, right: 600.0),
      child: Stack(
        children: <Widget>[
  ...
  // Adobe XD layer: 'Porcentaje 1' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 70.0, top: 130.0,bottom: 250.0, right: 600.0),
      child: Stack(
        children: <Widget>[
