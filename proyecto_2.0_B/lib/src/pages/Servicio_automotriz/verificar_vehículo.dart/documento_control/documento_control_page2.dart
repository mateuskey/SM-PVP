...
class DocumentoControlPage2 extends StatefulWidget {
  @override
  _DocumentoControlPage2State createState() => _DocumentoControlPage2State();
}

class _DocumentoControlPage2State extends State<DocumentoControlPage2> {
  @override
          ...
          child: ListView(
            children: [
              RaisedButton(
                ...
                color: Colors.white,
                onPressed: () {
                  Navigator.pushNamed(context, 'ControlVehiculoPage2');
                },
              ),
              ...
              RaisedButton(
                ...
                color: Colors.white,
                onPressed: () {
                  Navigator.pushNamed(context, 'docvehiculo2');
                },
              ),
            ],
          ),
