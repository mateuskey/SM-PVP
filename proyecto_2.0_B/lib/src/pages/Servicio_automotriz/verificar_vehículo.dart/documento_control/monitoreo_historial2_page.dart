...
import 'package:proyecto/src/providers/Firestore/control_veh%C3%ADculo2.dart';
import 'package:proyecto/src/utils/constants.dart';


class ControlVehiculoPage2 extends StatefulWidget {
  @override
  _ControlVehiculoPage2State createState() => _ControlVehiculoPage2State();
}

class _ControlVehiculoPage2State extends State<ControlVehiculoPage2> {

  void initState() {
    super.initState();
    Firebase.initializeApp().whenComplete(() { 
      print("Control vehículo 2");
      setState(() {});
    });
  }
  @override
  ...
  // 'Porcentaje 4' (group)
    return Padding(
      padding: const EdgeInsets.only(left: 140.0, top: 150.0,bottom: 165.0, right: 220.0),
      child: Stack(
        children: <Widget>[
