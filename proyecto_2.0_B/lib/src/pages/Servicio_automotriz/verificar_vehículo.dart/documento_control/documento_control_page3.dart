...
class DocumentoControlPage3 extends StatefulWidget {
  @override
  _DocumentoControlPage3State createState() => _DocumentoControlPage3State();
}

class _DocumentoControlPage3State extends State<DocumentoControlPage3> {
  @override
          ...
          child: ListView(
            children: [
              RaisedButton(
                ...
                color: Colors.white,
                onPressed: () {
                  Navigator.pushNamed(context, 'ControlVehiculoPage3');
                },
              ),
              ...
              RaisedButton(
                ...
                color: Colors.white,
                onPressed: () {
                  Navigator.pushNamed(context, 'docvehiculo3');
                },
              ),
            ],
          ),
