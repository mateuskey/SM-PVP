...
class ControlVehiculo2 extends StatefulWidget {
  @override
  _ControlVehiculo2State createState() => _ControlVehiculo2State();
}

class _ControlVehiculo2State extends State<ControlVehiculo2> {

  final DocumentReference documentReference = FirebaseFirestore.instance
      .collection('monitoreo_completo_tres').doc('a0JR1nLKzbhU8PriN3Ze');
      ...
      body: Container(
        ...
        child: Stack(
          ...
          stream: FirebaseFirestore.instance
              .collection('monitoreo_completo_tres')
              .snapshots(),
          builder:
