...
class ControlVehiculo3 extends StatefulWidget {
  @override
  _ControlVehiculo3State createState() => _ControlVehiculo3State();
}

class _ControlVehiculo3State extends State<ControlVehiculo3> {

  final DocumentReference documentReference = FirebaseFirestore.instance
      .collection('monitoreo_completo_cuatro').doc('c3xiBcTDOEL1QavFyiG1');
      ...
      body: Container(
        ...
        child: Stack(
          ...
          stream: FirebaseFirestore.instance
              .collection('monitoreo_completo_cuatro')
              .snapshots(),
          builder:
                ...
                return Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 270.0, top: 50.0, left: 30.0),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 270.0, top: 50.0, left: 5.0),
