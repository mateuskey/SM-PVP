...
class ControlVehiculo1 extends StatefulWidget {
  @override
  _ControlVehiculo1State createState() => _ControlVehiculo1State();
}

class _ControlVehiculo1State extends State<ControlVehiculo1> {

  final DocumentReference documentReference = FirebaseFirestore.instance
      .collection('monitoreo_completo_dos').doc('YOXqpUGVTMLFilzXr7hz');
      ...
      body: Container(
        ...
        child: Stack(
          ...
          stream: FirebaseFirestore.instance
              .collection('monitoreo_completo_dos')
              .snapshots(),
          builder:
                ...
                return Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 270.0, top: 50.0, left: 20.0),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 260.0, top: 30.0, left: 5.0),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 270.0, top: 60.0, left: 20.0),
