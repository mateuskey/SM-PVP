...
class LoginServicioAutomotriz extends StatefulWidget {
  @override
  _LoginServicioAutomotrizState createState() =>
      _LoginServicioAutomotrizState();
}

class _LoginServicioAutomotrizState extends State<LoginServicioAutomotriz> {
        ...
        child: Container(
          child: Column(
            children: [
              ...
              Container(
                child: Text('Servicio Automotriz',
                    style: TextStyle(
  ...
  _login(LoginBloc bloc, BuildContext context) async {
    ...
    if (info['ok']) {
      Navigator.pushReplacementNamed(context, 'homeservicio');
    } else {
