...
class DetallePorcomponentes extends StatefulWidget {

  final OpcMonitoreo opcMonitoreo;
  const DetallePorcomponentes({Key key, this.opcMonitoreo}) : super(key: key);

  @override
  _DetallePorcomponentesState createState() => _DetallePorcomponentesState();
}

class _DetallePorcomponentesState extends State<DetallePorcomponentes> with TickerProviderStateMixin{
